...
public interface DefinicionAutorizacionRepo extends JpaRepository<DefinicionAutorizacion, Long> {
    ...
    @Query(value = "select * from BS_DefinicionAutorizacion definicion left join BS_DetalleAutorizacion detalle on detalle.DefinicionAutorizacion = definicion.DefinicionAutorizacion where detalle.Rol = :rol and definicion.Producto = :producto and definicion.Cliente = :cliente", nativeQuery = true)
    ...
    @Query(value = "select * from BS_DefinicionAutorizacion definicion left join BS_DetalleAutorizacion detalle on detalle.DefinicionAutorizacion = definicion.DefinicionAutorizacion where detalle.Rol IN :roles and definicion.Producto = :producto and definicion.Cliente IN :clientes", nativeQuery = true)
    ...
    @Query(value = "select * from BS_DefinicionAutorizacion definicion left join BS_DetalleAutorizacion detalle on detalle.DefinicionAutorizacion = definicion.DefinicionAutorizacion where definicion.Producto = :producto and definicion.Cliente IN :clientes", nativeQuery = true)
